...
const Menu = () => {
    ...
    return (
        <div className="absolute w-64 z-20 rounded-xl bg-gray-200 px-2 py-2 mt-1 shadow-lg border border-gray-300 right-0"
            ...
            <div className="px-3 py-2 text-xs text-gray-500 font-semibold">Hi, {user.userName}!</div>
            <div onClick={() => dispatch(logout())} className="cursor-pointer flex items-center whitespace-nowrap text-sm font-normal font-mono rounded-xl px-3 py-2 active:bg-blue-600"
                index="2"
